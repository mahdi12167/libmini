...
# gdal
(cd gdal; ./configure --prefix=$prefix/gdal --with-libtiff=internal --with-geotiff=internal --with-png=internal --with-jpeg=internal --without-curl --without-netcdf --without-sqlite3 --without-pg --enable-static --disable-shared; make -j 2; make install)
