      ...
      if (TILECACHE->haselevini_geo())
         ...
         if (TILECACHE->haselevini_coordsys())
            if (TILECACHE->getelevini_coordsys()==databuf::DATABUF_CRS_LLH)
               ...
               LPARAMS.offsetDAT=minicoord(miniv3d(TILECACHE->getelevini_centerx(),TILECACHE->getelevini_centery(),0.0),minicoord::MINICOORD_OGH,TILECACHE->getelevini_coordsys_zone());
               LPARAMS.extentDAT=minicoord(miniv3d(TILECACHE->getelevini_sizex(),TILECACHE->getelevini_sizey(),2.0*LPARAMS.maxelev),minicoord::MINICOORD_OGH,TILECACHE->getelevini_coordsys_zone());
               }
         }
      else
         {
