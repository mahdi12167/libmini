   ...
   switch (type)
      ...
      case MINICOORD_LLH:
         switch (t)
            {
            case MINICOORD_MERC:
               miniutm::LL2MERC(vec.y,vec.x,&vec.x,&vec.y);
               type=t;
               utm_zone=utm_datum=0;
               break;
            case MINICOORD_UTM:
               miniutm::LL2UTM(vec.y,vec.x,zone,datum,&vec.x,&vec.y);
               type=t;
               utm_zone=zone;
               utm_datum=datum;
               break;
      ...
      case MINICOORD_MERC:
         switch (t)
            {
            case MINICOORD_LLH:
               miniutm::MERC2LL(vec.x,vec.y,&vec.y,&vec.x);
               type=t;
               utm_zone=utm_datum=0;
               break;
            case MINICOORD_UTM:
      ...
      case MINICOORD_UTM:
         switch (t)
            {
            case MINICOORD_LLH:
               miniutm::UTM2LL(vec.x,vec.y,utm_zone,utm_datum,&vec.y,&vec.x);
               type=t;
               utm_zone=utm_datum=0;
               break;
            case MINICOORD_MERC:
