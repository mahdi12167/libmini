   ...
   if (coord_sys==0)
      ...
      if (utm_zone!=NULL && utm_datum!=NULL)
         ...
         *utm_datum=coord_datum;
         ...
         // transform corners
         static minicrs CRS;
         CRS.UTM2LL(coord_SW_x,coord_SW_y,coord_zone,coord_datum,&coord_SW_y,&coord_SW_x);
         CRS.UTM2LL(coord_NW_x,coord_NW_y,coord_zone,coord_datum,&coord_NW_y,&coord_NW_x);
         CRS.UTM2LL(coord_NE_x,coord_NE_y,coord_zone,coord_datum,&coord_NE_y,&coord_NE_x);
         CRS.UTM2LL(coord_SE_x,coord_SE_y,coord_zone,coord_datum,&coord_SE_y,&coord_SE_x);
