...
inline void cliptri(const miniv3d &v0, // vertex v0
                    const miniv3d &v1, // vertex v1
                    const miniv3d &v2, // vertex v2
                    const miniv3d &o,  // origin of clip plane
                    const miniv3d &n)  // normal of clip plane
   {
   double d0,d1,d2;
   ...
   switch (ff)
      ...
      case 1: clip1tri(v0,fabs(d0),
                       v1,fabs(d1),
                       v2,fabs(d2)); break;
      case 2: clip1tri(v1,fabs(d1),
                       v0,fabs(d0),
                       v2,fabs(d2)); break;
      case 4: clip1tri(v2,fabs(d2),
                       v0,fabs(d0),
                       v1,fabs(d1)); break;
