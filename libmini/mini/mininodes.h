...
class mininode_group: public mininode
   ...
   virtual double shoot_ray(const miniv3d &o,const miniv3d &d,double hitdist=0.0) const;
...
class mininode_culling: public mininode_group
   ...
   //! shoot a ray and return the distance to the closest object
   double shoot_ray(const miniv3d &o,const miniv3d &d,double hitdist=0.0) const;
