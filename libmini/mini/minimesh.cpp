...
inline BOOLINT minimesh::isfront(const miniv3d &p,const miniv3d &v1,const miniv3d &v2,const miniv3d &v3,const miniv3d &e)
   {
   miniv3d n;

   n=(v2-v1)/(v3-v1);

   return(((v1-e)*n>0.0)?(p-v1)*n<0.0:(p-v1)*n>0.0);
   }

// calculate the intersection of a ray with a plane
inline double minimesh::intersect(const miniv3d &p,const miniv3d &d,const miniv3d &o,const miniv3d &d1,const miniv3d &d2,miniv3d &m)
   {
   miniv3d n;
...
inline void minimesh::draw3fan(const miniv3d &v1,const double c1,
...
void minimesh::draw4fan(const miniv3d &v1,const double c1,
                        const miniv3d &v2,const double c2,
                        const miniv3d &v3,const double c3,
                        const miniv3d &v4,const double c4,
                        const miniv3d &col,const double rho,
...
void minimesh::proj(const miniv3d &v1,const double c1,
                    const miniv3d &v2,const double c2,
                    const miniv3d &v3,const double c3,
                    const miniv3d &v4,const double c4,
                    const miniv3d &col,const double rho,
