...
IF (NOT BUILD_MINI_STUB)
   ...
   IF (NOT BUILD_MINI_WITH_OPENTHREADS)
      FIND_MINI_LIBRARY(PTHREAD_LIBRARY pthread "/usr")
      FIND_MINI_LIBRARY(PTHREAD_LIBRARY pthread "${PTHREAD_PATH}")
      FIND_MINI_LIBRARY(PTHREAD_LIBRARY pthread_static "${WIN32_PTHREAD_PATH}")
      FIND_MINI_PATH(PTHREAD_INCLUDE_DIR pthread.h "/usr")
      FIND_MINI_PATH(PTHREAD_INCLUDE_DIR pthread.h "${PTHREAD_PATH}")
      FIND_MINI_PATH(PTHREAD_INCLUDE_DIR pthread.h "${WIN32_PTHREAD_PATH}")
   ...
   ELSE (NOT BUILD_MINI_WITH_OPENTHREADS)
      ...
      FIND_MINI_PATH(OPENTHREADS_INCLUDE_DIR OpenThreads/Thread "${OPENTHREADS_PATH}")
      FIND_MINI_PATH(OPENTHREADS_INCLUDE_DIR OpenThreads/Thread "${WIN32_OPENTHREADS_PATH}")
   ...
   FIND_MINI_PATH(CURL_INCLUDE_DIR curl/curl.h "${CURL_PATH}")
   FIND_MINI_PATH(CURL_INCLUDE_DIR curl/curl.h "${WIN32_CURL_PATH}")
   ...
   FIND_MINI_PATH(JPEG_INCLUDE_DIR jpeglib.h "${JPEG_PATH}")
   FIND_MINI_PATH(JPEG_INCLUDE_DIR jpeglib.h "${WIN32_JPEG_PATH}")
   INCLUDE_DIRECTORIES(${JPEG_INCLUDE_DIR})

   # find PNG dependency
   FIND_MINI_LIBRARY(PNG_LIBRARY png "${PNG_PATH}")
   FIND_MINI_LIBRARY(PNG_LIBRARY libpng "${WIN32_PNG_PATH}")
   FIND_MINI_PATH(PNG_INCLUDE_DIR png.h "${PNG_PATH}")
   FIND_MINI_PATH(PNG_INCLUDE_DIR png.h "${WIN32_PNG_PATH}")
   INCLUDE_DIRECTORIES(${PNG_INCLUDE_DIR})

   # find ZLIB dependency
   FIND_MINI_LIBRARY(ZLIB_LIBRARY z "${ZLIB_PATH}")
   FIND_MINI_LIBRARY(ZLIB_LIBRARY zlib "${WIN32_ZLIB_PATH}")
   FIND_MINI_PATH(ZLIB_INCLUDE_DIR zlib.h "${ZLIB_PATH}")
   FIND_MINI_PATH(ZLIB_INCLUDE_DIR zlib.h "${WIN32_ZLIB_PATH}")
   INCLUDE_DIRECTORIES(${ZLIB_INCLUDE_DIR})

   # find Squish dependency
   FIND_MINI_LIBRARY(SQUISH_LIBRARY squish "${SQUISH_PATH}")
   FIND_MINI_LIBRARY(SQUISH_LIBRARY squish "${WIN32_SQUISH_PATH}")
   FIND_MINI_PATH(SQUISH_INCLUDE_DIR squish.h "${SQUISH_PATH}")
   FIND_MINI_PATH(SQUISH_INCLUDE_DIR squish.h "${WIN32_SQUISH_PATH}")
