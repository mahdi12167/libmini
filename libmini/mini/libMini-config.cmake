...
OPTION(BUILD_WITH_GREYC "Build with GREYCstoration." OFF)
...
SET_MINI_PATH(WIN32_PTHREAD_PATH pthreads)
...
MACRO(FIND_MINI_LIBRARY name file paths)
   IF (NOT ${name})
...
MACRO(FIND_MINI_PATH name file paths)
   IF (NOT ${name})
...
ELSE (NOT BUILD_WITH_OPENTHREADS)
   ...
   FIND_MINI_PATH(OPENTHREADS_INCLUDE_DIR OpenThreads/Thread "${OPENTHREADS_PATH} ${WIN32_OPENTHREADS_PATH}")
...
ENDIF (NOT BUILD_WITH_OPENTHREADS)
...
FIND_MINI_PATH(CURL_INCLUDE_DIR curl/curl.h "${CURL_PATH} ${WIN32_CURL_PATH}")
...
FIND_MINI_PATH(JPEG_INCLUDE_DIR jpeglib.h "${JPEG_PATH} ${WIN32_JPEG_PATH}")
INCLUDE_DIRECTORIES(${JPEG_INCLUDE_DIR})

# find PNG dependency
FIND_MINI_LIBRARY(PNG_LIBRARY png "${PNG_PATH}")
FIND_MINI_LIBRARY(PNG_LIBRARY libpng "${WIN32_PNG_PATH}")
FIND_MINI_PATH(PNG_INCLUDE_DIR png.h "${PNG_PATH} ${WIN32_PNG_PATH}")
INCLUDE_DIRECTORIES(${PNG_INCLUDE_DIR})

# find ZLIB dependency
FIND_MINI_LIBRARY(ZLIB_LIBRARY z "${ZLIB_PATH}")
FIND_MINI_LIBRARY(ZLIB_LIBRARY zlib "${WIN32_ZLIB_PATH}")
FIND_MINI_PATH(ZLIB_INCLUDE_DIR zlib.h "${ZLIB_PATH} ${WIN32_ZLIB_PATH}")
INCLUDE_DIRECTORIES(${ZLIB_INCLUDE_DIR})

# find Squish dependency
FIND_MINI_LIBRARY(SQUISH_LIBRARY squish "${SQUISH_PATH} ${WIN32_SQUISH_PATH}")
FIND_MINI_PATH(SQUISH_INCLUDE_DIR squish.h "${SQUISH_PATH} ${WIN32_SQUISH_PATH}")
