...
MACRO(SET_MYPATH name where subdir)
   SET(${name} ${LIBMINI_PATH} ${LIBMINI_PATH}/../${where}/${subdir})
   IF (LIBMINI_THIRDPARTY_DIR)
      SET(${name} ${${name}} ${LIBMINI_THIRDPARTY_DIR} ${LIBMINI_THIRDPARTY_DIR}/${subdir})
   ENDIF (LIBMINI_THIRDPARTY_DIR)
ENDMACRO(SET_MYPATH)

# paths to optional dependencies
SET_MYPATH(OPENTHREADS_PATH deps openthreads)
SET_MYPATH(CURL_PATH deps libcurl)
SET_MYPATH(JPEG_PATH deps libjpeg)
SET_MYPATH(PNG_PATH deps libpng)
SET_MYPATH(ZLIB_PATH deps zlib)
SET_MYPATH(SQUISH_PATH deps squish)
SET_MYPATH(GREYCSTORATION_PATH deps greycstoration)

# paths to WIN32 dependencies
SET_MYPATH(WIN32_PTHREAD_PATH WIN32 pthreads)
SET_MYPATH(WIN32_OPENTHREADS_PATH WIN32 openthreads)
SET_MYPATH(WIN32_CURL_PATH WIN32 libcurl)
SET_MYPATH(WIN32_JPEG_PATH WIN32 libjpeg)
SET_MYPATH(WIN32_PNG_PATH WIN32 libpng)
SET_MYPATH(WIN32_ZLIB_PATH WIN32 zlib)
SET_MYPATH(WIN32_SQUISH_PATH WIN32 squish)
SET_MYPATH(WIN32_FREEGLUT_PATH WIN32 freeglut)
...
IF (UNIX OR USE_PTHREAD_LIBRARY)
   IF (WIN32)
...
ELSE (UNIX OR USE_PTHREAD_LIBRARY)
...
ENDIF (UNIX OR USE_PTHREAD_LIBRARY)
