...
ClientUI::ClientUI(QString hostName, quint16 port, bool verify, bool compress, QWidget *parent)
   : QWidget(parent), hostName_(hostName), port_(port), verify_(verify), compress_(compress)
{
