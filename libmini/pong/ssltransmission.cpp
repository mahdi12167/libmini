                                                                    ...
                                                                    QObject *parent)
{
   ...
   // signal command
   connect(connection, SIGNAL(respond(SSLTransmission)),
           this, SLOT(respond(SSLTransmission)), Qt::QueuedConnection);
   ...
   // signal failure
   connect(connection, SIGNAL(failure(SSLTransmission)),
           this, SLOT(failure(SSLTransmission)), Qt::QueuedConnection);
...
void SSLTransmissionServerConnectionFactory::respond(SSLTransmission t)
{
   emit responded(t);
}

// receiver of transmission failures
void SSLTransmissionServerConnectionFactory::failure(SSLTransmission t)
{
   emit error(t);
}
