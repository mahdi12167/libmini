#########################################################################
#  From the autoconf macro archive to create the prefixed config file
#  that can be included in the distribution
#########################################################################
...
AC_DEFUN([AX_PREFIX_CONFIG_H],[
dnl AC_REQUIRE([AC_CONFIG_HEADER])
...
#########################################################################
#  From the autoconf macro archive to check for C++ namespace libraries
#########################################################################
