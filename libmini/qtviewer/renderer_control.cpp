...
//    //we delay one update in order to make sure the last step is moved properly
//    if (m_TransitingCameraForward == m_FocusingTargetVec)
//        return true;

//    miniv3d cameraForward = m_Camera.forwardGL;

//    miniv3d dirVec = m_FocusingTargetVec - cameraForward;

//    bool bFinished = false;
//    if (dirVec.getlength() > speed * dt)
//    {
//        dirVec.normalize();
//        m_TransitingCameraForward = cameraForward + dirVec * speed * dt;
//    }
//    else
//    {
//        m_TransitingCameraForward = m_FocusingTargetVec;
//    }
